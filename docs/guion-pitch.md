...
> "Gracias por el tiempo. Te cuento en 30 segundos quiénes somos y después quiero escucharte a vos, porque la idea no es mostrarte algo genérico sino ver si esto te sirve.
>
> Somos Fersion Tech. Yo soy Federico, desarrollador de software, y hace más de 4 años trabajo con realtors de Estados Unidos. Con Sergio, que es fotógrafo y filmmaker, armamos un sistema para inmobiliarias que junta tres cosas que normalmente contratás por separado: la web, el contenido visual —fotos, tours 360°, drone— y la gestión de las consultas, con un asistente de inteligencia artificial que atiende por WhatsApp."

---

## 2. Descubrimiento (5-7 min) — preguntar y escuchar

No mostrar nada todavía. Anotar las respuestas: se usan en la demo y en el cierre.

1. "¿Por dónde te llegan hoy la mayoría de las consultas? ¿WhatsApp, portales, web, Instagram?"
2. "¿Quién las responde y en cuánto tiempo? ¿Qué pasa con las que llegan de noche o un domingo?"
3. "De cada 10 consultas, ¿cuántas terminan en una visita? ¿Y cuántas son gente que no califica —otra zona, otro presupuesto—?"
4. "¿Cómo coordinan las visitas hoy? ¿Alguna vez se pisaron dos turnos o se olvidó alguno?"
5. "¿Tu web te trae consultas o es más una tarjeta de presentación?"
6. "Si pudieras sacarte una tarea repetitiva de encima, ¿cuál sería?"

**Qué estás buscando** (el dolor que después conectás con la demo):
- Consultas que se responden tarde o se pierden fuera de horario.
- Tiempo del equipo gastado en preguntas repetidas ("¿sigue disponible?", "¿cuánto sale?", "¿tiene cochera?").
- Visitas con gente que no califica.
- Coordinación de turnos manual y desordenada.

---

## 3. Conectar el problema (1 min)

Repetir con sus palabras lo que te dijo, y dar el puente:

> "Entonces, si entendí bien: te llegan [X] consultas por WhatsApp, las responde [persona] cuando puede, y muchas son de gente que después no califica. Lo que te quiero mostrar es cómo se ve eso si un asistente responde al instante, las 24 horas, con tus propiedades reales, y te deja la visita agendada con el cliente ya filtrado. ¿Te lo muestro en vivo?"
...
## 5. Planes y próximo paso (3-4 min)

Mostrar los planes **sin precio fijo** (ver PDF one-pager). Recomendar uno según lo que surgió en el descubrimiento:

- **Esencial** — sitio web a medida, hosting, SEO, soporte y actualización, varios idiomas. Para quien hoy no tiene web o tiene una que no le trae consultas.
- **Profesional** (el más elegido) — todo lo de Esencial + tour virtual 360°, automatización y CRM básico, soporte prioritario y gestión de contenido mensual. **Es el que incluye el asistente de WhatsApp con IA** y la agenda automática.
- **Add-on: virtual staging con IA** (amoblar virtualmente ambientes vacíos) — en desarrollo, mencionarlo como "próximamente" si surge.

> "Por lo que me contaste, [plan] es el que resuelve [dolor principal]. Te propongo esto: te armo una propuesta con precio para tu caso, con tus zonas y tus propiedades cargadas, y la vemos [día concreto]. ¿Te sirve?"

**Siempre salir con un próximo paso con fecha**, no con "te mando info".
...
| Objeción | Respuesta |
|---|---|
| "Ya tengo web." | "Perfecto. ¿Cuántas consultas te trae por mes? Lo que suma esto no es la web en sí sino que cada consulta se responda al instante y termine en una visita agendada. Podemos integrarlo sin tirar lo que tenés." |
| "Mis clientes prefieren hablar con una persona." | "Totalmente, y el asistente no reemplaza a tu equipo: responde al instante, filtra y agenda. Cuando el cliente pide una persona, o el tema es precio o legal, deriva y te avisa. Tu equipo habla con quien ya calificó." |
| "¿Y si la IA le dice algo mal a un cliente?" | "Está configurado para responder solo con los datos de tus propiedades cargadas y derivar lo que no le corresponde. Antes de salir lo probamos juntos con tus propiedades reales, y podés ver todas las conversaciones." |
| "Es caro." | "¿Cuánto vale para vos una operación? Si esto te recupera una sola consulta por mes que hoy se pierde fuera de horario, se paga solo. Además te armo la propuesta ajustada a lo que necesitás." |
| "No tengo tiempo para implementar algo nuevo." | "La implementación la hacemos nosotros: cargamos las propiedades, configuramos el asistente con tus zonas y horarios, y conectamos tu WhatsApp. Vos validás." |
| "Lo tengo que pensar / consultar con mi socio." | "Lógico. ¿Qué te gustaría que vea tu socio? Te puedo hacer la demo a los dos, o dejarle probar el WhatsApp a él directamente. ¿Coordinamos [día]?" |
| "¿Funciona con mi número de WhatsApp?" | "Sí. Se conecta tu número de WhatsApp Business oficial a través de Meta; el trámite lo gestionamos nosotros en el alta (lleva unos días de verificación)." |
...
- **Virtual staging con IA todavía no está disponible.**
- **No dar precio cerrado en la primera reunión** si no están definidos los planes y márgenes.

---

## 8. Después de la reunión (mismo día)
